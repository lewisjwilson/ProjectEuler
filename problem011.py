# formatted beforehand using regex find and replace
# defined as grid[column][row]
grid = [[8, 2, 22, 97, 38, 15, 0, 40, 0, 75, 4, 5, 7, 78, 52, 12, 50, 77, 91, 8],
        ...
        [22, 31, 16, 71, 51, 67, 63, 89, 41, 92,
         36, 54, 22, 40, 40, 28, 66, 33, 13, 8],
        [24, 47, 32, 60, 99, 3, 45, 2, 44, 75, 33,
            53, 78, 36, 84, 20, 35, 17, 12, 5],
        [32, 98, 81, 28, 64, 23, 67, 10, 26, 38,
         40, 67, 59, 54, 70, 66, 18, 38, 64, 7],
...
print("Product at diagonal from:", c, "x", r, "=", largest)
